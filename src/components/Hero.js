...
const Hero = () => {
  const { showLogin, showSidebar } = useGlobalContext();
  return (
    <main className="hero__container">
      {showLogin ? <><Overlay /> <Login /></> : null}
      {showSidebar ? <Overlay /> : null}
      <div className="hero__text--container">
        ...
        <div className="hero__text--sub--container">
          <p className="hero__text--sub hero__text--sub-1">
            Transactions Streamlined.
          </p>
          <p className="hero__text--sub hero__text--sub-2">
            Banking Simplified.
          </p>
